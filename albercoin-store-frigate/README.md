...
The controller UI is built from this app package (copying `app/` and `web/` into the runtime image) and Frigate runs from `ghcr.io/remcoros/frigate-docker:latest`.
