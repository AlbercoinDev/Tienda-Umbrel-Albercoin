...
The controller UI runs from a prebuilt image at `ghcr.io/albercoindev/albercoin-store-frigate-controller` and Frigate runs from `ghcr.io/remcoros/frigate-docker:latest`.
